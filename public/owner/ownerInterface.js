...
let data;
let cards = document.querySelectorAll(".shop");
let nextButton = document.querySelector(".suiv");
let previousButton = document.querySelector(".prev");
let pageText = document.querySelector(".numpage");
var addshop = document.querySelector('.addshopinterface');
addshop.addEventListener("click",e=>{
    document.body.style.overflow = "hidden";
    document.getElementById('addpopuptext').innerHTML=`Create`;
    document.getElementById('addButton').innerHTML = 'Create';
    document.getElementById('addcancelButton').innerHTML = 'Cancel';
    document.getElementById('addpopupContainer').style.display = 'flex';
    setTimeout(function() {
        document.getElementById('addpopupContainer').style.opacity = '1';
        document.getElementById('addpopupContent').style.opacity = '1';
        document.getElementById('addpopupContent').style.transform = 'translateY(0)';
    }, 50);
    document.getElementById('addcancelButton').addEventListener('click', function() {
        document.getElementById('addpopupContainer').style.opacity = '0';
        document.getElementById('addpopupContent').style.opacity = '0';
        document.getElementById('addpopupContent').style.transform = 'translateY(-20px)';
        setTimeout(function() {
            document.getElementById('addpopupContainer').style.display = 'none';
        }, 300);
    ...
    document.querySelector('.addbuttons').appendChild(editbutton)
    document.getElementById('addButton').addEventListener('click', async function() {
        fullnameadd = document.querySelector(".addchiefinputs").querySelector(".fullname");
        phonenumberadd = document.querySelector(".addchiefinputs").querySelector(".phonenumber");
        emailadd = document.querySelector(".addchiefinputs").querySelector(".email");
        shopnameadd = document.querySelector(".addshopinputs").querySelector(".shopname");
        addressadd = document.querySelector(".addshopinputs").querySelector(".address");
        ...
        if(!test){
            ...
            d.accounts.forEach(element =>{
                if(element.owner && element.email == localStorage.getItem("owner")){
                    owner = element;
                }
            })
            document.querySelector('.none').querySelector('.ownername').value = owner.fullname;
...
async function loadName(){
    ...
    card.innerHTML = owner.fullname;
}
function deleteshop(shopname,email){
    document.body.style.overflow = "hidden";
    document.getElementById('popuptext').innerHTML=`Delete ${shopname}?`;
    ...
    document.querySelector('.deletepopup').querySelector('.popupContent').appendChild(editbutton)
    document.getElementById('deleteButton').addEventListener('click', async function() {
        ok = await axios.get("/api/v1/articles/byemail/"+email)
        ok = ok.data.articles;
        await ok.forEach(async (element)=>{
            p = await axios.delete("/api/v1/articles/byid/"+element._id)
        })
...
async function editshop(shopname, email){
    ...
    ok = ok.data.shop
    document.body.style.overflow = "hidden";
    chiefnameinput = document.querySelector(".chiefinputs").querySelector(".fullname");
    phonenumberinput = document.querySelector(".chiefinputs").querySelector(".phonenumber");
    emailinput = document.querySelector(".chiefinputs").querySelector(".email");
    shopnameinput = document.querySelector(".shopinputs").querySelector(".shopname");
    addressinput = document.querySelector(".shopinputs").querySelector(".address");
    ...
    document.getElementById('editpopuptext').innerHTML=`Edit ${shopname}`;
    document.getElementById('editButton').innerHTML = 'Save';
    document.getElementById('editcancelButton').innerHTML = 'Cancel';
    document.getElementById('editpopupContainer').style.display = 'flex';
    setTimeout(function() {
        document.getElementById('editpopupContainer').style.opacity = '1';
        document.getElementById('editpopupContent').style.opacity = '1';
        document.getElementById('editpopupContent').style.transform = 'translateY(0)';
    }, 50);
    document.getElementById('editcancelButton').addEventListener('click', function() {
        document.getElementById('editpopupContainer').style.opacity = '0';
        document.getElementById('editpopupContent').style.opacity = '0';
        document.getElementById('editpopupContent').style.transform = 'translateY(-20px)';
        setTimeout(function() {
    ...
    document.querySelector('.editbuttons').appendChild(editbutton)
