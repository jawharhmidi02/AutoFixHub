...
async function myLoad(){
    ...
    devsdata.forEach(element =>{
        if(element.username == localStorage.getItem('devusername')){
            devaccount = element;
        }
    })
    id = localStorage.getItem('id');
    // id = '661402230c422326d4a9dbe4';
    dataarticle = await axios.get("/api/v1/articles/byid/"+id);
    dataarticle = dataarticle.data.article;
    // document.querySelector('.firstline').innerHTML = dataarticle.title;
    document.querySelector('.firstpart').innerHTML = dataarticle.title;
    document.title = 'Auto Fix Hub: ' + dataarticle.title;
    document.querySelector('.firstpart').innerHTML = dataarticle.title;
    document.querySelector('.secondpart').querySelector('img').src = dataarticle.image;
    document.querySelector('.secondpart').querySelector('.desc').innerHTML = dataarticle.description;
    document.querySelector('.thirdpart').innerHTML = dataarticle.moredetails;
    t = new Date(dataarticle.date).toLocaleString();
    t = t.slice(0, t.indexOf(","));
    document.querySelector('.fourthpart').querySelector('.time').innerHTML = t;
    rates = document.querySelectorAll(".stars");
    for(var j = 0; j < Math.round(dataarticle.rating); j++){
        rates[j].classList.add("checked");
    }
    document.querySelector('.ratenum').innerHTML = dataarticle.rating.toFixed(1)
    document.querySelector('.sixthpart').querySelector('.num').innerHTML = "&nbsp"+dataarticle.users+"&nbsp"
    
    var email = dataarticle.email;
    datashop = await axios.get('/api/v1/shops/'+email);
    datashop = datashop.data.shop;
    document.querySelector('.eighthpart').querySelector('.shopname').innerHTML = datashop.shopname;
    document.querySelector('.ninthpart').querySelector('.shopphone').innerHTML = '<i class="fa fa-phone"></i>'+datashop.phonenumber;
    document.querySelector('.ninthpart').querySelector('.shopmail').innerHTML = '<i class="fa fa-envelope"></i>'+datashop.email;
    document.querySelector('.tenthpart').querySelector('.location').innerHTML = '<i class="fa fa-map-marker"></i>'+datashop.address;
    
}

async function myLoadright(){
    data = await axios.get("/api/v1/articles");
    data = data.data.articles;
    
    sortedByDateAsc = [... data];
    sortedByRatesAsc = [... data];
...
searchButton.addEventListener("click", (e) => {
    ...
    location.href = 'devpanel.html';
    
})

document.querySelector('.articledeletebutton').addEventListener('click',function(){
    ...
    document.querySelector('.deletearticlepopup').querySelector('.popupContent').appendChild(editbutton)
    document.querySelector('.deletearticlepopup').querySelector('.deleteButton').addEventListener('click', async function() {
        OK = await axios.delete("/api/v1/articles/byid/" + localStorage.getItem('id'));
        newupdatelog = 'At "'+new Date()+'" :<br>'+'The dev "'+localStorage.getItem('devusername')+'" article article with id :"'+localStorage.getItem('id')+'"';
...
document.querySelector('.articleeditbutton').addEventListener('click',function(){
    document.body.style.overflow = "hidden";
    titleinput = document.querySelector('.editarticlepopup').querySelector('.title');
    imageinput = document.querySelector('.editarticlepopup').querySelector('.image');
    descriptioninput = document.querySelector('.editarticlepopup').querySelector('.description');
    tagsinput = document.querySelector('.editarticlepopup').querySelector('.tags');
    moredetailsinput = document.querySelector('.editarticlepopup').querySelector('.moredetails');
    ...
    moredetailsinput.innerHTML = dataarticle.moredetails;
    document.querySelector('.editarticlepopup').querySelector('.popuptext').innerHTML=`Edit ${dataarticle.title}`;
    document.querySelector('.editarticlepopup').querySelector('.deleteButton').innerHTML = 'Save';
    document.querySelector('.editarticlepopup').querySelector('.cancelButton').innerHTML = 'Cancel';
    document.querySelector('.editarticlepopup').querySelector('.popupContainer').style.display = 'flex';
    setTimeout(function() {
        document.querySelector('.editarticlepopup').querySelector('.popupContainer').style.opacity = '1';
        document.querySelector('.editarticlepopup').querySelector('.popupContent').style.opacity = '1';
        document.querySelector('.editarticlepopup').querySelector('.popupContent').style.transform = 'translateY(0)';
    }, 50);
    document.querySelector('.editarticlepopup').querySelector('.cancelButton').addEventListener('click', function() {
        document.querySelector('.editarticlepopup').querySelector('.popupContainer').style.opacity = '0';
        document.querySelector('.editarticlepopup').querySelector('.popupContent').style.opacity = '0';
        document.querySelector('.editarticlepopup').querySelector('.popupContent').style.transform = 'translateY(-20px)';
        setTimeout(function() {
            document.querySelector('.editarticlepopup').querySelector('.popupContainer').style.display = 'none';
        }, 300);
        document.body.style.overflow = "";
    });
    document.querySelector('.editarticlepopup').querySelector('.deleteButton').remove()
    editbutton = document.createElement('button')
    editbutton.innerHTML = "Save"
    editbutton.classList.add("deleteButton")
    editbutton.classList.add("Button")
    editbutton.setAttribute("id",'deleteButton')
    document.querySelector('.editarticlepopup').querySelector('.popupContent').appendChild(editbutton)
    document.querySelector('.editarticlepopup').querySelector('.deleteButton').addEventListener('click', async function() {
        titleinput = document.querySelector('.editarticlepopup').querySelector('.title').value;
        imageinput = document.querySelector('.editarticlepopup').querySelector('.image').value;
        descriptioninput = document.querySelector('.editarticlepopup').querySelector('.description').value;
        tagsinput = document.querySelector('.editarticlepopup').querySelector('.tags').value;
        newmoredetailsinput = document.querySelector('.editarticlepopup').querySelector('.moredetails');
        if (titleinput == "") {
        ...
        OK = await axios.patch("/api/v1/articles/byid/" + localStorage.getItem('id'), {
            "title" : titleinput,
            "image" : imageinput,
        ...
        newupdatelog = 'At "'+new Date()+'" :<br>'+'The dev "'+localStorage.getItem('devusername')+'" edited article with id :"'+localStorage.getItem('id')+'"';
        ok = await axios.patch("/api/v1/devs/"+devaccount.username,{
            "updatelog" : newupdatelog+'<br>'+devaccount.updatelog,
            "email" : devaccount.email,
            "password" : devaccount.password,
